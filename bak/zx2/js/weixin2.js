...
function sendmess2(){
	if (clickNumber == 0) {
		document.getElementById('messbox').innerHTML = document.getElementById('messbox').innerHTML + '<div class="line"><div class="left"> <a href="xiangxi2.htm?wxid='+cur_tips.wechat+'"><img src="images/header.png" width="40px"></a><div> <i></i> 你好，我是'+cur_tips.name+'有什么问题请讲。如果打字不方便也可以直接加我本人的微信号：<span style="color:#fff;background:#f00;padding:0 7px;font-size:18px;font-weight: bold;">' + cur_tips.wechat + '</span> </div></div><div class="ly-clear"></div></div>';
